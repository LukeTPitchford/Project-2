...
<head>
    <title>Code coverage report for src/components/AddressMinimap.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/components</a> AddressMinimap.tsx</h1>
        <div class='clearfix'>
...
<a name='L238'></a><a href='#L238'>238</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">16x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/* eslint-disable @typescript-eslint/no-namespace */
&nbsp;
...
&nbsp;
  // Update show.
  useEffect(() =&gt; {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!ref.current) <span class="cstat-no" title="statement not covered" >return;</span>
    if (show) {
      ref.current.show();
    } else {
      ref.current.hide();
