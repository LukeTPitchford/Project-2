...
<head>
    <title>Code coverage report for src/components/AddressAutofill.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/components</a> AddressAutofill.tsx</h1>
        <div class='clearfix'>
...
<a name='L306'></a><a href='#L306'>306</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">10x</span>
...
&nbsp;
    ...
    useEffect(() =&gt; {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!node) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
      if (!onSuggest) return;
&nbsp;
