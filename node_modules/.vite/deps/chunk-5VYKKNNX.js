...
var ARIA_DESCRIPTION_ID = "address-autofill__description";
var createAriaLiveElement = () => {
  ...
  description.setAttribute("id", ARIA_DESCRIPTION_ID);
  container.appendChild(description);
  return container;
};
var setLiveRegionMessage = (message) => {
  var _a;
  const description = (_a = document.body.querySelector(`[id="${ARIA_DESCRIPTION_ID}"]`)) != null ? _a : null;
  if (description) {
...
var MapboxAddressAutofill = class extends HTMLScopedElement {
  ...
  connectedCallback() {
    ...
    const input = (_a = this.querySelector("input")) != null ? _a : null;
    if (input) {
      input.insertAdjacentElement("beforebegin", createAriaLiveElement());
...
var MapboxSearchBox = class extends HTMLScopedElement {
  ...
  get templateUserStyle() {
    return getThemeCSS(".Input", __privateGet2(this, _listbox2).theme);
  }
  get theme() {
  ...
  set theme(theme) {
    ...
    const input = __privateGet2(this, _input2);
    if (!input) {
      return;
    }
...
var MapboxAddressMinimap = class extends HTMLScopedElement {
  constructor() {
    ...
    __privateAdd2(this, _toggleMarkerEditing, () => {
      const { ImageContainer, ButtonAdjust, ButtonSave, ButtonCancel } = __privateGet2(this, _binding5);
    ...
    __privateAdd2(this, _updateImageSrc, () => {
      if (__privateGet2(this, _feature2)) {
        ...
        const { Image } = __privateGet2(this, _binding5);
    ...
    __privateAdd2(this, _setSize, () => {
      const { MapboxAddressMinimap: MapboxAddressMinimap2, ImageContainer, Image } = __privateGet2(this, _binding5);
    ...
    __privateAdd2(this, _addMarkerEditControls, () => {
      ...
      __privateSet2(this, _binding5, __spreadProps2(__spreadValues2({}, __privateGet2(this, _binding5)), {
      ...
      const { ButtonAdjust, ButtonSave, ButtonCancel } = __privateGet2(this, _binding5);
    ...
    __privateAdd2(this, _removeMarkerEditControls, () => {
      if (!__privateGet2(this, _binding5))
        return;
      const { EditButtons, ButtonAdjust, ButtonSave, ButtonCancel } = __privateGet2(this, _binding5);
      const existingFooter = this.querySelector(".MinimapFooter");
      ...
      delete __privateGet2(this, _binding5).EditButtons;
      delete __privateGet2(this, _binding5).ButtonAdjust;
      delete __privateGet2(this, _binding5).ButtonSave;
      delete __privateGet2(this, _binding5).ButtonCancel;
    });
    __privateAdd2(this, _addSatelliteToggle, () => {
      ...
      __privateGet2(this, _binding5).MapStyleToggle = toggleElement;
  ...
  set theme(theme) {
    ...
    const { Marker, MapStyleToggle } = __privateGet2(this, _binding5);
  ...
  show() {
    ...
    __privateSet2(this, _url, __privateGet2(this, _getImageUrl).call(this, lngLat));
    const { MapboxAddressMinimap: MapboxAddressMinimap2, Image } = __privateGet2(this, _binding5);
    Image.src = __privateGet2(this, _url);
    MapboxAddressMinimap2.removeAttribute("aria-hidden");
  }
  hide() {
    const { MapboxAddressMinimap: MapboxAddressMinimap2 } = __privateGet2(this, _binding5);
  ...
  connectedCallback() {
    ...
    const { MapboxAddressMinimap: MapboxAddressMinimap2, ImageContainer, Image, Marker } = __privateGet2(this, _binding5);
...
var AddressAutofillInstance = class {
  constructor(collection, input, autofillRef) {
    ...
    __privateAdd2(this, _collection, void 0);
    __privateAdd2(this, _session3, void 0);
    this.options = {};
    this.retrieveFeature = null;
    this.listbox = new MapboxSearchListbox();
    __privateAdd2(this, _initialAutocompleteValue2, void 0);
    __privateAdd2(this, _onHandleInput3, (e) => {
      const value = e.detail;
      const enableBrowserAutocomplete = __privateGet2(this, _collection).browserAutofillEnabled === true && (value == null ? void 0 : value.length) <= 2;
      toggleAutocompletion(__privateGet2(this, _input3), __privateGet2(this, _initialAutocompleteValue2), enableBrowserAutocomplete);
      if ((value == null ? void 0 : value.length) <= 2) {
        this.listbox.handleSuggest(null);
        return;
      }
      __privateGet2(this, _session3).suggest(value, this.options);
    });
    __privateAdd2(this, _onHandleSelect3, (e) => {
      const suggestion = e.detail;
      if (e.detail.accuracy !== "street") {
        toggleAutocompletion(__privateGet2(this, _input3), __privateGet2(this, _initialAutocompleteValue2), true);
        __privateGet2(this, _session3).retrieve(suggestion, this.options);
      } else {
        handleStreetSelection(__privateGet2(this, _input3), __privateGet2(this, _initialAutocompleteValue2), suggestion);
      }
    });
    ...
    __privateAdd2(this, _onHandleFocus2, () => {
      var _a;
      const enableBrowserAutocomplete = __privateGet2(this, _collection).browserAutofillEnabled === true && ((_a = __privateGet2(this, _input3).value) == null ? void 0 : _a.length) <= 2;
      toggleAutocompletion(__privateGet2(this, _input3), __privateGet2(this, _initialAutocompleteValue2), enableBrowserAutocomplete);
    });
    __privateAdd2(this, _handleSuggest3, (result) => {
      ...
      Object.defineProperty(event, "target", { value: __privateGet2(this, _input3) });
      __privateGet2(this, _collection).fire("suggest", event);
    });
    __privateAdd2(this, _handleSuggestError3, (error) => {
      this.listbox.handleError();
      const event = new MapboxHTMLEvent("suggesterror", error);
      Object.defineProperty(event, "target", { value: __privateGet2(this, _input3) });
      __privateGet2(this, _collection).fire("suggesterror", event);
    });
    __privateAdd2(this, _handleRetrieve3, (result) => {
      var _a;
      const event = new MapboxHTMLEvent("retrieve", result);
      Object.defineProperty(event, "target", { value: __privateGet2(this, _input3) });
      __privateGet2(this, _collection).fire("retrieve", event);
      this.retrieveFeature = (_a = result.features) == null ? void 0 : _a[0];
      ...
      fillFormWithFeature(featureCollection.features[0], __privateGet2(this, _input3));
    });
    __privateSet2(this, _input3, input);
    __privateSet2(this, _collection, collection);
    __privateSet2(this, _session3, new SearchSession(autofillRef));
    __privateGet2(this, _session3).sessionToken = config.autofillSessionToken;
    this.listbox.input = __privateGet2(this, _input3);
    this.listbox.autofillHost = this;
    this.listbox.searchService = 0;
    this.listbox.addEventListener("input", __privateGet2(this, _onHandleInput3));
    this.listbox.addEventListener("select", __privateGet2(this, _onHandleSelect3));
    this.listbox.addEventListener("blur", __privateGet2(this, _onHandleBlur3));
    this.listbox.addEventListener("focus", __privateGet2(this, _onHandleFocus2));
    ...
    if (input) {
      input.insertAdjacentElement("beforebegin", createAriaLiveElement());
      suppressExtensionsAutocomplete(input);
      __privateSet2(this, _initialAutocompleteValue2, input.autocomplete);
    }
  }
  get input() {
  ...
  remove() {
    this.listbox.remove();
    this.listbox.removeEventListener("input", __privateGet2(this, _onHandleInput3));
    this.listbox.removeEventListener("select", __privateGet2(this, _onHandleSelect3));
    this.listbox.removeEventListener("blur", __privateGet2(this, _onHandleBlur3));
    this.listbox.removeEventListener("focus", __privateGet2(this, _onHandleFocus2));
  ...
  simulateRetrieve(feature) {
    const input = __privateGet2(this, _input3);
    if (input) {
      input.dataset["mapboxSuccess"] = "true";
    }
    ...
    __privateGet2(this, _handleRetrieve3).call(this, simResult);
  }
};
...
var AddressAutofillCollection = class extends Evented {
  constructor({
    ...
    super();
    this.instances = [];
    __privateAdd2(this, _currentInputs, void 0);
    __privateAdd2(this, _autofill2, new AddressAutofillCore());
    __privateAdd2(this, _options2, void 0);
    __privateAdd2(this, _theme, void 0);
    __privateAdd2(this, _popoverOptions2, void 0);
    this.confirmOnBrowserAutofill = false;
    this.browserAutofillEnabled = false;
    __privateAdd2(this, _handleObserve2, () => {
      if (!deepEquals(findAddressInputs(), __privateGet2(this, _currentInputs))) {
        this.update();
      }
    });
    __privateAdd2(this, _observer2, new MutationObserver(__privateGet2(this, _handleObserve2)));
    __privateAdd2(this, _handleBrowserAutofill2, (e) => __async2(this, null, function* () {
    ...
    initDetectBrowserAutofill();
    window.addEventListener("browserautofill", __privateGet2(this, _handleBrowserAutofill2));
    config.autofillSessionEnabled = true;
  ...
  get accessToken() {
    return __privateGet2(this, _autofill2).accessToken;
  }
  set accessToken(newToken) {
    __privateGet2(this, _autofill2).accessToken = newToken;
  }
  get options() {
    return __privateGet2(this, _options2);
  }
  set options(newOptions) {
    __privateSet2(this, _options2, __spreadValues2(__spreadValues2({}, __privateGet2(this, _options2)), newOptions));
    this.instances.forEach((instance) => {
      instance.options = __spreadValues2(__spreadValues2({}, instance.options), newOptions);
    });
  }
  get theme() {
    return __privateGet2(this, _theme);
  }
  set theme(newTheme) {
    __privateSet2(this, _theme, newTheme);
    this.instances.forEach((instance) => {
      instance.listbox.theme = newTheme;
    });
  }
  get popoverOptions() {
    return __privateGet2(this, _popoverOptions2);
  }
  set popoverOptions(newOptions) {
    __privateSet2(this, _popoverOptions2, newOptions);
    this.instances.forEach((instance) => {
  ...
  update() {
    ...
    __privateSet2(this, _currentInputs, findAddressInputs());
    this.instances = [];
    __privateGet2(this, _currentInputs).forEach((input) => {
      const autofillInstance = new AddressAutofillInstance(this, input, __privateGet2(this, _autofill2));
  ...
  observe() {
    __privateGet2(this, _observer2).observe(document, {
      subtree: true,
      childList: true
    });
    __privateGet2(this, _handleObserve2).call(this);
  }
  unobserve() {
    __privateGet2(this, _observer2).disconnect();
  }
  remove() {
    this.instances.forEach((instance) => {
      instance.remove();
    ...
    this.unobserve();
    window.removeEventListener("browserautofill", __privateGet2(this, _handleBrowserAutofill2));
  }
};
...
focus-trap/dist/focus-trap.esm.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-5VYKKNNX.js.map
